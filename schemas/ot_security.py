"""
UrbanNexus Smart-City Use Case: OT Security Specialist Schemas
"""
from pydantic import BaseModel, Field
from typing import List, Optional
from .common import Evidence, Risk, Requirement

class OTSecurityFinding(BaseModel):
    """
    Represents the findings of the OT Security Engineer agent.
    """
    topic: str = Field("ot_security", description="The topic of the finding.")
